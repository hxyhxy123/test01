...
public class ShopServiceImpl extends ServiceImpl<ShopMapper, Shop> implements IShopService {
    ...
    public Result shopInsert(Shop shop) {
        shopMapper.shopInsertTo(shop);
        return Result.ok(shop);
    }

    @Override
    public Result queryShopOne(String name) {
        Shop shop=shopMapper.shopSelectOne(name);
        return Result.ok(shop);
    }

    @Override
    public Result queryShopTwo(Long shopId) {
        Shop shop=shopMapper.shopSelectTwo(shopId);
        return Result.ok(shop);
    }
